...
<body class="homepage">
   ...
   <header id="main-header">
   	...
   	<div class="row header-inner">
	      ...
	      <div class="logo">
	         <a class="smoothscroll" href="#hero">101ideas.</a>
	      </div>
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
				...
				<li><a class="smoothscroll" href="#"> Today @ <?php  $time_now=mktime(date('h')+5,date('i')+30,date('s')); $date = date('d-m-Y H:i', $time_now); echo $date; ?> 
</a></li>
	         </ul> 
				   ...
				   <ul class="slides">
					   ...
					   <li>
						   <div class="flex-caption">
								<h1>Hello, we are 101ideas. We make awesome and stunning digital stuff.</h1>	
   ...
   <footer>
      ...
      <div class="row">       
            ...
            <div class="row">
               ...
               <div class="columns">
                  ...
                  <ul>
                    ...
                    <li><a href="mailto:someone@101ideas.com">someone@101ideas.com</a></li>
                  </ul>                  
               </div> <!-- /columns -->             
         ...
         <p class="copyright">&copy; Copyright 2014 101ideas. Design by <a href="http://www.qaptivecom/">qaptive</a></p>        
